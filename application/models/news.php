...
class News extends CI_Model
{
	...
	public function get_news($start, $limit)
	{
		...
		$posts = $db->from('topics')->select(array('topics.topic_status AS locked', 'topics.forum_id', 'topics.topic_id', 'topics.topic_time AS date', 'topics.topic_replies AS replies', 'posts.enable_bbcode', 'posts.post_subject AS headline', 'posts.post_text AS text'))
